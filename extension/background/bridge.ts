import { PROTOCOL_VERSION, type BridgeChatProgress, type BridgeChatResponse, type BridgeMessage, type BridgeRequest, type JsonValue, parseBridgeMessage } from "../../shared/protocol";
